...
const JobNest = () => {
  const project = projectData.find((p) => p.id === "job-nest");
    ...
    <section className="min-h-screen px-6 py-24 text-white relative z-10">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          className="backdrop-blur-xl bg-white/4 border border-white/10 rounded-3xl p-10 shadow-[0_0_40px_rgba(168,85,247,0.2)]"
        >
